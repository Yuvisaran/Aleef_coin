        ...
        axios.post(loginUrl, payLoad)
            .then(response => {
                ...
                if (response.status == 200 && response.data.loginInfo.roleId == 1) {
                    ...
                    // TODO : need to navigate otp page after client testing completion
                    // this.props.history.push('/userdashboard');
                }
                else if (response.status == 206) {
                    notify.show(response.data.message, "error");
    ...
    render() {
        return (
            ...
            <div className="aleef-signin">
                        ...
                        <ul>
                            <li>
                                {/* <a href="javascript:void(0);">
                                    <i className="fa fa-facebook facebook-clr" aria-hidden="true"></i>
                                </a> */}
                                <GoogleLogin
                ...
                {/* {this.state.isForgetPwd && <div className='loaderBg loaderimg'>
                                        ...
                                        <div className="reset-password">
                                            <form action="" method="post">
                                                ...
                                                <div className="modal-footer">
                                                    <button type="button" className="btn btn-resent" data-dismiss="modal" onSubmit={this.toggleResetPwd} disabled={this.state.oldPassword == "" || this.state.password == "" || this.state.confirmPassword == ""} >Submit</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div className="reset-passwd-cont">
                                    <form name="deleteTokens">
                                        ...
                                        <div className="form-group text-center">
                                            ...
                                            {/* <button className="sub-btn red-clr" >CANCEL</button> */}
                                        </div>
                                    </form>
                                </div>
                            </div>

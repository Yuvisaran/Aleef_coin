                            ...
                            <div className="aleef-signin-form">
                                ...
                                <form>
                                    ...
                                    {/* <div className="form-group">
                                        ...
                                        <input type="text" placeholder="+91 123 4566 1546" name='mobileNo' value={this.state.mobileNo} onChange={this.handleChange} />
                                    ...
                                    <div className="form-group">
                                        ...
                                        {/* <span className="" onClick={this.showHide}>{this.state.type === 'input' ? 'Hide' : 'Show'}</span> */}
                                        {/* <span className="error-msg">Invalid Email address</span> */}
                                    ...
                                    <div className="form-group">
                                        ...
                                        {/* <span className="" onClick={this.showHide1}>{this.state.type === 'input' ? 'Hide' : 'Show'}</span> */}
                                        {/* <span className="error-msg">Invalid 2FA Code</span> */}

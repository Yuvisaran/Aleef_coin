...
class MyProfile extends React.Component {
    constructor(props) {
        ...
        // } else if (sessionInfo.kycStatus == 1 || sessionInfo.kycStatus == 2) {
    ...
    componentDidMount() {
        ...
        const apiBaseUrl = API_BASE_URL + "view/user/kyc";
        axios.post(apiBaseUrl, payload)
            .then(response => {
                if (response.status === 200) {
                    // sessionStorage.setItem('kycInfo', JSON.stringify(response.data.kycUserInfo));
                    this.setState({ kycData: response.data.kycUserInfo });
    ...
    validateField1(fieldName, value) {
        ...
        //         fieldValidationErrors.password = passwordValid ? '' : 'Must contain minimum 8 character';
        //         break;
    ...
    handleChange(e) {
        const value = e.target.value;
        const name = e.target.name;
        Object.assign(this.state.kycData, { [e.target.name]: e.target.value });
        this.setState({ [name]: value },
    ...
    uploadKycDetails(event) {
        ...
        const details = {
            ...
            "emailId": sessionInfo.emailId || this.state.emailId, "city": this.state.city, "mobileNo": sessionInfo.mobileNo || this.state.mobileNo
        }
        ...
        // this.setState({ fullName: "", mobileNo: " ", emailId: "", dob: "", city: "", homeAddress: "", gender: '' });
                                    ...
                                    <form onSubmit={this.uploadKycDetails}>
                                        <div className="col-md-6 col-sm-6 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label col-sm-5" htmlFor="email">Full Name *</label>
                                                <div className="col-sm-6">
                                                    <input type="text" className="form-control" onChange={this.handleChange} value={this.state.kycData.fullName || this.state.fullName || ''} name="fullName" required />
                                        ...
                                        <div className="col-md-6 col-sm-6 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label col-sm-5" htmlFor="email">Date Of Birth *</label>
                                                <div className="col-sm-6">
                                                    <input type="date" className="form-control" max={"9999-12-31"} onChange={this.handleChange} value={this.state.kycData.dob || this.state.dob || ''} name="dob" required />
                                        ...
                                        <div className="col-md-6 col-sm-6 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label col-sm-5" htmlFor="email">Gender *</label>
                                                <div className="col-sm-6 selct">
                                                    <select value={this.state.kycData.gender || this.state.gender} onChange={this.handleCheck} required>
                                                        <option name="male"> Male</option>
                                                        <option name="female">Female</option>
                                                        <option name="female">Other</option>
                                                    </select>
                                                    {/* <input type="text" className="form-control" onChange={this.handleChange} value={this.state.gender || ''} name="gender" /> */}
                                        ...
                                        <div className="col-md-6 col-sm-6 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label col-sm-5" htmlFor="email"> Address/City *</label>
                                                <div className="col-sm-6">
                                                    <input type="text" className="form-control" onChange={this.handleChange} value={this.state.kycData.address || this.state.homeAddress || ''} name="homeAddress" required />
                                        ...
                                        <div className="col-md-6 col-sm-6 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label col-sm-5" htmlFor="email">Country *</label>
                                                <div className="col-sm-6 selct">
                                                    {/* <input type="text" className="form-control" onChange={this.handleChange} value={this.state.city || ''} name="city" /> */}
                                                    <CountryDropdown
                                                        value={this.state.kycData.country || this.state.country}
                                        ...
                                        <div className="col-md-6 col-sm-6 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label col-sm-5" htmlFor="email">State *</label>
                                                <div className="col-sm-6 selct">
                                                    {/* <input type="text" className="form-control" onChange={this.handleChange} value={this.state.country || ''} name="country" /> */}
                                                    <RegionDropdown
                                                        country={this.state.kycData.country || this.state.country}
                                                        value={this.state.kycData.city || this.state.region}
                                        ...
                                        <div className="col-md-6 col-sm-6 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label col-sm-5" htmlFor="email">Mobile No. *</label>
                                                <div className="col-sm-6">
                                                    <IntlTelInput
                                                        name='mobileNo'
                                                        value={this.state.kycData.mobileNo || this.state.mobileNo || ''}
                                        ...
                                        <div className="col-md-6 col-sm-6 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label col-sm-5" htmlFor="email">Email Id *</label>
                                                <div className="col-sm-6">
                                                    <input type="email" className="form-control" onChange={this.handleChange} value={this.state.kycData.emailId || this.state.sessionInfo.emailId || this.state.emailId || ''} name="emailId" readOnly />
                                        ...
                                        <div className="col-md-6 col-sm-6 col-xs-12">
                                            <div className="form-group">
                                                <label className="control-label col-sm-5" htmlFor="email"> Photo ID *</label>
                                                <div className="col-sm-6">
                                        ...
                                        {/* </div> */}
                                        <div className="btnBg">
                                            <button type="submit" className="kycSubmit kycSubBtn" disabled={!(this.state.city == "" || this.state.homeAddress == "" || this.state.dob == "" || this.state.file1 == "" || this.state.gender == "" || this.state.emailId == "" || this.state.fullName == "")}>Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </section>
                                    ...
                                    <div className="reset-password">
                                        <form action="" method="post">
                                            ...
                                            <div className="form-group">
                                                ...
                                                {/* <div style={{ color: 'red' }}>{this.state.errors.secretPin}</div> */}
                                            </div>
                                        </form>
                                    </div>
                                </div>
